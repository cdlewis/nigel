...
Task Runner is a CLI tool that automates iterative code improvements using Claude AI. It follows a simple loop: identify issues via candidate sources, send them to Claude for fixing, verify results, and commit successful changes.
