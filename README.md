...
nigel mytask --shard 1/4  # Terminal 1 (first of 4 workers)
nigel mytask --shard 2/4  # Terminal 2 (second of 4 workers)
nigel mytask --shard 3/4  # Terminal 3
nigel mytask --shard 4/4  # Terminal 4
